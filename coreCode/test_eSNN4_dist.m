function [ Accuracy, predicted_labels, active_val_all ] = test_eSNN4_dist( repos,testData,Param )
...
for i=1:N
  ...
  %      parfor_progress;
    ...
    [~, ~, class_label, active_val] = propagate_fast2(spikes,repos,Param);
    clear spikes
    ...
    if ~ isempty(class_label)% non of the output neurons emittied a spike 
        ...
        active_val_all(i) = active_val;
    else
        predicted_labels(i)=NaN;
        active_val_all(i) = NaN;
