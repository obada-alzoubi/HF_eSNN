...
s2 = strsplit(s1{1},'''');
testFilename = sprintf('data/test%s.mat', s2{2},string(trainBatchSizeRatio));
...
batchFilename = sprintf('data/batch%s%s.mat', s2{2},string(trainBatchSizeRatio));
...
fileName = sprintf('data/mainRepos_%s%s.mat',s2{2}, string(trainBatchSizeRatio));
...
fileName = sprintf('data/finalRepos%s%s.mat',s2{2},string(trainBatchSizeRatio));
