...
Param.search.m_range = [0.1:0.1:0.9 0.91:0.01:0.99 0.995];
...
[ best_param ] = gridSearchforBeta2( data, Param );
% Write the results 
output_file = sprintf('bp_Beta_%s_%s.mat', Param.dist, Param.pdf_option);
